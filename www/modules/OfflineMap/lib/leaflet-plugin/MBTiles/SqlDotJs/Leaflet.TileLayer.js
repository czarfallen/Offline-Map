...
L.TileLayer.MBTilesSql = L.TileLayer.extend({
    ...
    initialize: function(databaseUrl, options) {
        ...
        if (typeof databaseUrl === 'string') {
            ...
            // This cause error on platform that is not browser
 ...
 */
L.tileLayer.MBTilesSql = function(databaseUrl, options) {
    return new L.TileLayer.MBTilesSql(databaseUrl, options);
}
